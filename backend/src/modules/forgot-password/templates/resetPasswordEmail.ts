/**
 * Template HTML do e-mail de redefinição de senha (doc 04 §10: extraído do
 * antigo `SendMail.ts` para uma função pura, sem I/O). O HTML é idêntico ao
 * original — apenas o código de verificação (`token`) é interpolado.
 */
                 ...
                 <tr>
                  <td align="center" valign="top" style="padding:0;Margin:0;width:540px">
                   <table cellpadding="0" cellspacing="0" width="100%" role="presentation" style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:collapse;border-spacing:0px">
                     ...
                     <tr>
                      <td align="center" style="padding:0;Margin:0;padding-top:10px;padding-bottom:10px"><p style="Margin:0;-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;font-family:roboto, 'helvetica neue', helvetica, arial, sans-serif;line-height:24px;color:#ffffff;font-size:16px">${token}</p></td>
                     </tr>
                   </table></td>
                 </tr>
               </table></td>
